function d3_minimap(){
	var selection,
    	...
    	color_scale = d3.scale.linear()
    		.domain([0, 10, 50, 75, 95, 100])
    		.range(['rgba(189,0,38,0.8)','rgba(240,59,32,0.8)','rgba(253,141,60,0.8)','rgba(254,204,92,0.8)','rgba(255,255,178,0.8)','rgba(0,0,0,0.8)']);
	...
	function minimap(sel){
		...
		d3.csv('data/all.csv', function(err, data){
			...
			d3.json('data/berlin_bezirke.json', function(err, data){
				geo_data = data;
				minimap.init();
			});
		});
