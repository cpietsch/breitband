...
function Timeline(){
  ...
  chart.load = function(data){
    ...
    // nest.forEach(function(type){
    //   type.values.forEach(function(bezirk){
    //     bezirk.mean = d3.mean(bezirk.values, function(d){ return d.value; });
    //     bezirk.values.forEach(function(ortsteil){
    //       ortsteil.mean = bezirk.mean;
    //     })
    //   })
    // })
